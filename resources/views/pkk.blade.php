...
@section('content')
        ...
        <div class="heading">
            <div class="container">
                <div class="row d-flex justify-content-center text-center">
                    <div class="col-lg-8">
                        <h1>PKK</h1>
                        <p class="mb-0">Susunan kepengurusan PKK 12 Jatiwaringin</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="team" class="team section">
        ...
        <div class="container section-title" data-aos="fade-up">
            <p>Struktur PKK 12</p>
            <h2>Susunan kepengurusan PKK 12 Jatiwaringin</h2>
        </div><!-- End Section Title -->
        <div class="container">
            <div class="row gy-4">
                <div class="container">
                    <div class="row gy-4">
                        @forelse ($strukturalpkk as $item)
    ...
    <section id="bagan" class="section bg-light">
        <div class="container" data-aos="fade-up">
            <div class="section-title">
                <p>Bagan PKK Anyelir</p>
                <h2>Struktur visual kepengurusan PKK Anyelir</h2>
            </div>
