            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card">
                        ...
                        <form action="{{ route('management_pengguna.store') }}" method="POST"
                            enctype="multipart/form-data" class="modal-content">
                            <div class="card-body">
                                <div class="form-group">
                                    <label class="form-label" for="select rt">Gambar</label>
                                    <input type="file" class="form-control form-control"
                                        placeholder="Masukan Gambar Pengguna"
                                        name="gambar" required>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Laki-Laki</label>
                                    <input type="number" class="form-control form-control"
                                        placeholder="Masukan Jumlah Penduduk Laki-Laki" value="{{ $item->laki_laki }}"
                                        name="laki_laki" required>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Perempuan</label>
                                    <input type="number" class="form-control form-control"
                                        placeholder="Masukan Jumlah Penduduk Perempuan" value="{{ $item->perempuan }}"
                                        name="perempuan" required>
                                </div>
                                <div class="form-group">
