...
<body data-pc-preset="preset-1" data-pc-direction="ltr" data-pc-theme="light">
                            ...
                            <div class="dropdown-header px-0 text-wrap header-notification-scroll position-relative"
                                ...
                                <div class="list-group list-group-flush w-100">
                                    ...
                                    <a class="list-group-item list-group-item-action">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="../assets_admin/images/user/avatar-1.jpg" alt="user-image"
                                                    class="user-avtar">
                                            </div>
                                            <div class="flex-grow-1 ms-1">
                                    ...
                                    <a class="list-group-item list-group-item-action">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="../assets_admin/images/user/avatar-3.jpg" alt="user-image"
                                                    class="user-avtar">
                                            </div>
                                            <div class="flex-grow-1 ms-1">
                                    ...
                                    <a class="list-group-item list-group-item-action">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="../assets_admin/images/user/avatar-4.jpg" alt="user-image"
                                                    class="user-avtar">
                                            </div>
                                            <div class="flex-grow-1 ms-1">
    ...
    {{-- main content --}}
    <div class="pc-container">@yield('content_admin')
            ...
            <div class="row">
                <div class="col-sm my-1">
                    <p class="m-0">SmartHub &#9829; crafted by Team <a
                        ...
                        Distributed by <a href="https://www.nusamandiri.ac.id/nuri/index.js">Universitas Nusa Mandiri</a>.</p>
                </div>
